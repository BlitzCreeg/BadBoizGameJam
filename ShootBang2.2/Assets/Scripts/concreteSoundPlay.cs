...
public class concreteSoundPlay : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        clipIndex = RepeatCheck(clipIndex, concreteMissArray.Length);
        targetSource.PlayOneShot(concreteMissArray[clipIndex]);
    }
